      ...
      {full ? (
        <>
          <Lede className="mt-[9px] max-w-[60ch]">
            {plan.plan === 'monitor'
              ? `Every slot on your plan is in use: ${inWords(usage.domains.used)} of ${inWords(usage.domains.limit)}. Remove a domain to make room for this one.`
              : `The free plan holds one domain and yours is in it. The agency plan watches up to ${inWords(PLAN_LIMITS.agency.domains)} domains and re-checks them every week.`}
          </Lede>
